 ...
 * <pre>
 *  CharSequence chars = ColorPhraseHelper.from("I'm<Chinese>,I love <China>").
 *                                                              withSeparator("<>").
 ...
 */
public class ColorPhraseHelper {
    /**
    ...
    public static ColorPhraseHelper from(Fragment f, int patternResourceId) {
     ...
     * @throws IllegalArgumentException if pattern contains any syntax errors.
     */
    public static ColorPhraseHelper from(View v, int patternResourceId) {
     ...
     * @throws IllegalArgumentException if pattern contains any syntax errors.
     */
    public static ColorPhraseHelper from(Context c, int patternResourceId) {
     ...
     * @throws IllegalArgumentException if pattern contains any syntax errors.
     */
    public static ColorPhraseHelper from(Resources r, int patternResourceId) {
     ...
     * @throws IllegalArgumentException if pattern contains any syntax errors.
     */
    public static ColorPhraseHelper from(CharSequence pattern) {
        return new ColorPhraseHelper(pattern);
    }

    private ColorPhraseHelper(CharSequence pattern) {
     ...
     * @return
     */
    public ColorPhraseHelper withSeparator(String separator) {
     ...
     * @return
     */
    public ColorPhraseHelper outerColor(int outerColor) {
     ...
     * @return
     */
    public ColorPhraseHelper innerColor(int innerColor) {
