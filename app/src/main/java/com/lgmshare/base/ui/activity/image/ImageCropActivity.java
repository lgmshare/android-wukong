...
import com.lgmshare.base.widget.cropimage.CropImageView;
import com.lgmshare.base.widget.cropimage.Util;
...
public class ImageCropActivity extends MonitoredActivity {
    ...
    private void onSaveClicked() {
        ...
        // step mTencentSearch so that we don't require that the whole (possibly large)
        ...
        if (myExtras != null && (myExtras.getParcelable("data") != null || myExtras.getBoolean("return-data"))) {
            ...
            Util.startBackgroundJob(ImageCropActivity.this, null, (String) getText(R.string.image_select_crop_img), new Runnable() {
                public void run() {
                    saveOutput(b);
                }
            }, mHandler);
