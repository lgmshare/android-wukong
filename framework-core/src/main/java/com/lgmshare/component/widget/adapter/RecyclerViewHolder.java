...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    protected RecyclerViewHolder(Context context, View view) {
        super(view);
    ...
    public RecyclerViewHolder setImageUrl(int viewId, String imageUrl, int defResourceId) {
        ImageView view = getView(viewId);
        Glide.with(mContext).load(imageUrl).crossFade().placeholder(defResourceId).into(view);
        return this;
    }

    public RecyclerViewHolder setImageUrl(int viewId, String imageUrl, int defResourceId, BitmapTransformation... transformations) {
        ImageView view = getView(viewId);
    ...
    public RecyclerViewHolder setOnClickListener(int viewId, FrameRecyclerAdapter.OnAdapterItemChildClickListener listener) {
