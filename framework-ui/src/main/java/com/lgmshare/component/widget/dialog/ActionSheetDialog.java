...
public class ActionSheetDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleView = (TextView) findViewById(R.id.actionsheet_title);
        mContentScrollView = (ScrollView) findViewById(R.id.actionsheet_scrollView);
        mContentLayout = (LinearLayout) findViewById(R.id.actionsheet_items);
        mCancelView = (TextView) findViewById(R.id.actionsheet_cancel);
     ...
     * @return
     */
    public void addSheetItem(String item, OnSheetItemClickListener listener) {
        if (mSheetItemList == null) {
            mSheetItemList = new ArrayList<SheetItem>();
        }
        mSheetItemList.add(new SheetItem(item, SheetItemColor.Gray, listener));
    }
    ...
    public enum SheetItemColor {
        Gray("#4C4C4C"), Blue("#037BFF"), Red("#FD4A2E");
